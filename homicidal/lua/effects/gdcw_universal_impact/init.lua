--[[File Path:   gamemodes/homicide/entities/effects/gdcw_universal_impact/init.lua
...
function EFFECT:Init(data)
	...
	if mats[self.Mat][1] == 1 then
		self:Dust()
	elseif mats[self.Mat][1] == 2 then
		self:Dirt()
	elseif mats[self.Mat][1] == 3 then
		self:Sand()
	elseif mats[self.Mat][1] == 4 then
		self:Metal()
	elseif mats[self.Mat][1] == 5 then
		self:Smoke()
	elseif mats[self.Mat][1] == 6 then
		self:Wood()
	elseif mats[self.Mat][1] == 7 then
		self:Glass()
	elseif mats[self.Mat][1] == 8 then
		self:Blood()
	elseif mats[self.Mat][1] == 9 then
		self:YellowBlood()
	else
		self:Smoke()
	end
