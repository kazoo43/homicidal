--[[File Path:   gamemodes/homicide/entities/weapons/wep_jack_hmcd_poisonliquid.lua
...
SWEP.IconTexture = "vgui/wep_jack_hmcd_poisonliquid"
...
function SWEP:AttackFront()
	...
	if IsValid(Ent) and (Ent.IsLoot or (Ent:GetClass() == "prop_physics") or (Ent:GetClass() == "prop_physics_multiplayer") or (Ent:GetClass() == "func_breakable_surf")) then
